                        ...
                        using (TransactionScope transactionScope = new TransactionScope())
                        {
                            try
                            {
                                using (kryptoEntities1 db = new kryptoEntities1())
                                {
                                    ...
                                    //var res = db.UserRegitrationForInitialLogins.SingleOrDefault(x => x.USERID == ulinfo.USERID);
                                    //if (res!=null)
                                    //{
                                    //    res.ModifiedDate = ulinfo.ModifiedDate.Value; 
                                    //    res.ModifiedById = loggedinUser.USERID.ToString();
                                    //    res.IsInitialLogin = true;
                                    //    res.IsTermsAccepted = false;
                                    //    res.IsSecQuestEnabled = false;
                                    //    res.IsMpinCreated = false;
                                    //    res.IsPasswordUpdated = false;
                                    //    res.Status = 1;
                                    ...
                                    //else
                                    //{
                                    //    res.USERID = ulinfo.USERID;
                                    //    res.Createdate = DateTime.Now;
                                    //    res.CreatedById = loggedinUser.USERID.ToString();
                                    //    res.ModifiedDate = ulinfo.ModifiedDate.Value;
                                    //    res.ModifiedById = loggedinUser.USERID.ToString();
                                    //    res.IsInitialLogin = true;
                                    //    res.IsTermsAccepted = false;
                                    ...
                                    //    res.IsPasswordUpdated = false;
                                    //    res.Status = 1;
                                    //    db.UserRegitrationForInitialLogins.Add(res);
                                    //}
                                    //db.SaveChanges();
